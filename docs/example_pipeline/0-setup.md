...
This is the tool that allows us to easily write NeXus NDXL files.
...
We are creating a `pynxtools` reader plugin, i.e., a converter from raw data to NeXus. For this we are working with the [`pynxtools` plugin template](https://github.com/FAIRmat-NFDI/pynxtools-plugin-template). 
